            ...
            <form action="" className="px-4">
              <FormControl>
                <Input
                  ...
                  type="text"
                  labelText="Type Name"
                  value={specilityInput}
                  onChange={(e) => setSpecilityInput(e.target.value)}
                />
              </FormControl>
              <FormFooter className="pb-4">
                ...
                {edit ? (
                  <Button
                    className={!specilityInput && "cursor-not-allowed"}
                    nodata={!specilityInput ? true : false}
                    onClick={(e) => Update(e)}
                  >
                    Update
                  </Button>
...
export default SpecialitiesSetupModal;
