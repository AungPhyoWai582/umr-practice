            ...
            <form action="" className="px-4">
              ...
              <FormControl>
                <TextArea
                  ...
                  value={depTextArea}
                  onChange={(e) => setDepTextArea(e.target.value)}
                />
              </FormControl>
              <FormFooter className="pb-4">
                ...
                {edit ? (
                  <Button
                    className={(!depInput || !depTextArea) && "cursor-not-allowed"}
                    nodata={(!depInput || !depTextArea) ? true : false}
                    onClick={(e) => Update(e)}
                  >
                    Update
                  </Button>
...
export default DepartmentSetupModal;
